...
builder.Services.AddDbContext<CarsContext>(options =>
    options.UseSqlServer("Server=DESKTOP-5MOS2IA\\SQLEXPRESS;Database=FIIPracticCars;Trusted_Connection=True;Encrypt=True;TrustServerCertificate=True;")
...
//app.MapControllerRoute(
//    name: "users",
//    pattern: "{controller=Usersd}/{action=Index}/{id?}");
